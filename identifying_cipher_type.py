"""
Write a Python program that takes a string of ciphertext as input and
determines whether it is more likely to be a transposition cipher or a substitution cipher. 
"""
...
print('\nSix most-frequenly-used letters in English = ETAOIN')
...
if count/len(TARGET) >= CUTOFF:
    ...
    print("\nThis ciphertext most-likely produced by a SUSTITUTION cipher.")
